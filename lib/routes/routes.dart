...
class MyRoute {
  Route onRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case "/teacher":
        return MaterialPageRoute(builder: (context) => TeacherPage());
      case "/teacher/attendance":
        return MaterialPageRoute(builder: (context) => const ClaassPage());
      ...
      case "/teacher/recap/course":
        return MaterialPageRoute(builder: (context) => const CourseRecapPage());
      default:
